(function () {
  ...
  var MovingObject = Asteroids.MovingObject = function (obj) {
    ...
    this.rotation = 0;
    this.imageIndexX = 0;
    this.imageIndexMaxX = 1;
    this.imageIndexY = 0;
    this.imageIndexMaxY = 1;
    this.aniMax = 10;
    this.aniTick = 0;
  };
  ...
  MovingObject.prototype.tickAnimation = function () {
    this.aniTick += 1;
    if (this.aniTick >= this.aniMax) {
      this.imageIndexX = (this.imageIndexX + 1) % this.imageIndexMaxX;
      this.aniTick = 0;
    }
  }
